...
import { maliciousZip, metadataZip } from '../../../../tools/test/zip-fixture.mts';
import { craftedTar } from '../../../../tools/test/tar-fixture.mts';
...
async function base() {
  ...
  run('tar', [
    ...
    runtime,
    '-C',
    path.dirname(runtimeSource),
    path.basename(runtimeSource),
  ]);
