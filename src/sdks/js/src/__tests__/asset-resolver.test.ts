...
async function nodeDirectAddonReleaseMetadataMatchesTypeScriptAssets(): Promise<void> {
  ...
  assert.equal(
    nodeDirectAddonReleaseAssetUrl('0.1.0', 'oliphaunt-node-direct-0.1.0-linux-x64-gnu.tar.gz'),
    'https://github.com/f0rr0/oliphaunt/releases/download/oliphaunt-node-direct-v0.1.0/oliphaunt-node-direct-0.1.0-linux-x64-gnu.tar.gz',
  );
  assert.equal(
    nodeDirectAddonReleaseAssetUrl('0.1.0', 'oliphaunt-node-direct-0.1.0-windows-x64-msvc.zip'),
    'https://github.com/f0rr0/oliphaunt/releases/download/oliphaunt-node-direct-v0.1.0/oliphaunt-node-direct-0.1.0-windows-x64-msvc.zip',
  );
  assert.throws(
    () => nodeDirectAddonReleaseAssetUrl('0.1.0', '../evil.tar.gz'),
