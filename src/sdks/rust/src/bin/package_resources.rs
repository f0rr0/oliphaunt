...
use oliphaunt::{
    ...
    NativePrebuiltExtensionArtifact, NativeRuntimeResourceOptions, build_native_runtime_resources,
    list_prebuilt_extension_artifact_index_catalog,
...
Usage:
  oliphaunt-resources --output <dir> [--mode direct|broker|server] [--extension hstore,vector] [--extension-index <index.toml>] [--extension-target <target>] [--extension-cache <dir>] [--trusted-extension-index-key-file <key-id>:<path>] [--prebuilt-extension <artifact>] [--mobile-static-module vector] [--force] [--require-mobile-static-registry]
