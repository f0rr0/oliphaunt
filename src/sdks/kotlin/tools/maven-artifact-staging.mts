#!/usr/bin/env bun
import { parseMavenArtifactManifest } from '../../../shared/artifact-packaging/maven-artifact-manifest.mts';
...
import { createDeterministicZip } from '../../../shared/artifact-packaging/archive-directory.mts';
import {
  createSiblingStage,
  promoteDirectory,
  removeTemporaryPath,
} from '../../../shared/artifact-packaging/atomic-directory.mts';
import { validateMavenCentralPublication } from '../../../shared/artifact-packaging/maven-central-contract.mts';
