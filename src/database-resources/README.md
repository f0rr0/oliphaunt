...
```sh
OLIPHAUNT_SEED_RUNTIME_DIR=/path/to/runtime bash src/database-resources/seeds/build.sh native standard
OLIPHAUNT_SEED_RUNTIME_DIR=/path/to/wasix/runtime bash src/database-resources/seeds/build.sh wasix standard
```
