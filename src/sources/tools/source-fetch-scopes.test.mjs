...
test('focused runtime and extension scopes do not fetch one another', () => {
  ...
  assert.equal(scopeIncludesExtensions('wasix-runtime'), false);
  ...
  assert.equal(scopeIncludes('wasix-runtime', sourceOrigins.extension), false);
