...
const POSTGRES_PATCH_SERIES_PATH: &str = "src/wasix/runtime/postgres/series";
const POSTGRES_PREPARE_SCRIPT: &str = "src/wasix/runtime/assets/build/prepare_postgres_source.sh";
...
fn print_usage() {
    ...
    eprintln!("  bash src/wasix/runtime/tools/serialize-aot.sh --target-triple <triple>");
    eprintln!(
