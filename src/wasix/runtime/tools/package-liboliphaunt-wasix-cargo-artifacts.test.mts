...
if (!scratch) throw new Error('Run bash src/wasix/runtime/tools/test-packaging.sh');
...
[dependencies]
liboliphaunt-wasix-portable = { path = ${JSON.stringify(path.join(ROOT, 'src/wasix/runtime/crates/assets'))}, features = ["extension-cube"] }
