...
async function main() {
  ...
  try {
    ...
    // Archive member paths remain stable across checkout reorganizations.
    for (const [source, member] of [
      ['src/extensions/generated', 'src/extensions/generated'],
      ['src/wasix/runtime/assets/generated', 'src/runtimes/liboliphaunt-wasix/assets/generated'],
    ]) {
      copyTree(path.join(ROOT, source), path.join(portable, member));
    }
