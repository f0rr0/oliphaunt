...
const PACKAGE_ROOT = path.join(WORKSPACE_ROOT, 'src/wasix/node-addon');
...
const PGWIRE_CLIENT = pathToFileURL(
  path.join(WORKSPACE_ROOT, 'src/wasix/sdks/ts/tools/pgwire-client.mts'),
).href;
