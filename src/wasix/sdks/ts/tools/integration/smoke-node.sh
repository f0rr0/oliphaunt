...
cp "$root/src/wasix/sdks/ts/tools/entrypoint-consumer.ts" "$scratch/consumer/entrypoint-consumer.mts"
"$root/src/wasix/sdks/ts/node_modules/.bin/tsc" --noEmit --strict --skipLibCheck \
