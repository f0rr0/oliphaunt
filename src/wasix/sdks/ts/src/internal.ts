...
import type {
  WasixToolWorkerRequest,
  WasixToolWorkerResponse,
} from './hosts/browser/tool-worker-common.js';

import { getWasixDatabaseIdentity } from './core/database.js';
...
function createBrowserToolWorker(): WasixToolWorkerPort {
  ...
  const worker = new Worker(new URL('./hosts/browser/tool-worker.js', import.meta.url), {
    type: 'module',
