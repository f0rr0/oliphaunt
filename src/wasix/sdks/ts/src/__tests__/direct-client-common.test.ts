...
} from '../protocol/byte-channel.js';
import {
  type DirectWasixDependencies,
  type DirectWasixHost,
  DirectWasixSession,
  prepareRuntimeCached,
} from '../hosts/browser/direct-client-common.js';
...
import type { SerializedOpenOptions, WorkerRequest, WorkerResponse } from '../workers/rpc.js';
import { WASIX_PHYSICAL_IDENTITY, type WasixStorageLease } from '../storage/storage-provider.js';
