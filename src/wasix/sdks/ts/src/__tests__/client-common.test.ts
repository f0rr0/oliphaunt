...
import { restoreWasix, serializeOpenConfig } from '../hosts/browser/client-common.js';
import { indexedDB } from '../storage/indexed-db.js';
import type { WasixRuntimeDescriptor } from '../core/types.js';
import { openWasixWithWorker, restoreWasixWithWorker } from '../workers/worker-rpc.js';
