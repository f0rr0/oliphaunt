...
import type { NativeWasixActorSession } from '../hosts/node-api/native-session.js';
...
import { openNodeActorSession } from '../hosts/node-api/node-actor.js';
import { requireNodeStorage } from '../hosts/node-api/node-client-common.js';
