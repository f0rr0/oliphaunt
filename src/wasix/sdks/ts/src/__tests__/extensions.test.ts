...
import type { ExtractedArchive, WasixRuntimeLayout } from '../resources/archive.js';
import {
...
import type { SerializedExtensionCarrier, SerializedRuntimeDescriptor } from '../workers/rpc.js';
