...
crate=$(OLIPHAUNT_CARGO_NOTICE_PROFILE=source-sdk bash tools/packaging/package-cargo-source.sh src/wasix/pgwire-server/Cargo.toml "$PWD/target/sdk-artifacts-work/oliphaunt-pgwire-server")
