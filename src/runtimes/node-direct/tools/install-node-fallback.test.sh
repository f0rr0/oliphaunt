...
extractor="$root/src/runtimes/node-direct/tools/extract-node-headers.mts"
...
mkdir -p "$fixtures"
node "$root/src/runtimes/node-direct/tools/install-node-fallback.fixture.mts" "$fixtures"
