...
bash "$root/tools/dev/bun.sh" "$root/src/runtimes/liboliphaunt/native/tools/smoke-packed-tools-npm.mts" "$asset_dir" "$scratch"
...
export OLIPHAUNT_LOGICAL_TOOLS_CONTRACT="$root/src/shared/fixtures/postgres/logical-tools.json"
export OLIPHAUNT_LOGICAL_TOOLS_SEED="$root/src/shared/fixtures/postgres/logical-tools-seed.sql"
export OLIPHAUNT_LOGICAL_TOOLS_VERIFY="$root/src/shared/fixtures/postgres/logical-tools-verify.sql"
cd "$scratch"
