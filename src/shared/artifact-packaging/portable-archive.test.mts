...
import { zipArchive, crc32 } from '../../../tools/test/zip-fixture.mts';
...
import { tarArchive, tarOctal } from '../../../tools/test/tar-fixture.mts';
...
test('accepts POSIX directory type flags and rejects file entries with directory markers', (t) => {
  const valid = fixtureFile(
    t,
    'directory.tar.gz',
    tarArchive([
...
test('accepts ZIPs emitted by the canonical archive-directory producer', (t) => {
  ...
  const result = spawnSync(
    ...
    ['src/shared/artifact-packaging/archive-directory.mts', '--keep-parent', source, output],
...
test('artifact ZIP type validation supports sparse ZIP64 and rejects unsafe or truncated metadata', (t) => {
