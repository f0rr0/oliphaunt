...
export function extensionProjections(catalog: Row, releases: Row[]): Map<string, string> {
  ...
  for (const [sdk, includeIos] of [
    ...
    const type = fields
      ...
      .join('\n');
    outputs.set(
      `src/native/sdks/${sdk}/src/generated/extensions.ts`,
  ...
  outputs.set(
    'src/examples/native/react-native-expo/src/generated/extension-smoke.ts',
  ...
  outputs.set(
    'src/native/sdks/kotlin/oliphaunt/src/commonMain/kotlin/dev/oliphaunt/GeneratedExtensions.kt',
  ...
  outputs.set(
    'src/native/sdks/kotlin/oliphaunt-android-gradle-plugin/src/main/resources/dev/oliphaunt/android/extensions.properties',
    [
      `# This file is generated by ${modelPath}.`,
      '# Do not edit by hand.',
  ...
  outputs.set(
    'src/native/rust-bindings/src/generated/extensions.rs',
    rustModule(
      metadataRows.map((row) => ({
        ...row,
...
export function catalogProjections(catalog: Row): Map<string, string> {
  ...
  outputs.set(
    'src/wasix/sdks/rust/src/oliphaunt/generated_extensions.rs',
