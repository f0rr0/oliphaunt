...
const POLICY_PATH = join(ROOT, 'src/native/runtime/tools/native-runtime-payload-policy.json');
...
export { WINDOWS_VC_RUNTIME_DLLS };
...
function usage() {
  return `Usage: src/native/runtime/tools/native-runtime-payload.mts <root> [options]
