...
usage() {
  cat >&2 <<'MSG'
usage: src/native/runtime/bin/build-postgres18-linux.sh [--runtime-only|--print-required-extension-artifacts|--check-current|--check-extension-artifacts-current]
MSG
}
