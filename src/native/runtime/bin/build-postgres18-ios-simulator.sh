...
patch_dir="$repo_root"
patch_series_file="$repo_root/src/native/runtime/postgres/series"
...
liboliphaunt_sources=(
  "$repo_root/src/native/runtime/src/liboliphaunt_native.c"
  "$repo_root/src/native/runtime/src/liboliphaunt_error.c"
  "$repo_root/src/native/runtime/src/liboliphaunt_runtime.c"
  "$repo_root/src/native/runtime/src/liboliphaunt_protocol.c"
  "$repo_root/src/native/runtime/src/liboliphaunt_config.c"
  "$repo_root/src/native/runtime/src/liboliphaunt_process.c"
  "$repo_root/src/native/runtime/src/liboliphaunt_trace.c"
  "$repo_root/src/native/runtime/src/liboliphaunt_fs.c"
  "$repo_root/src/native/runtime/src/liboliphaunt_backup_state.c"
  "$repo_root/src/native/runtime/src/liboliphaunt_archive.c"
  "$repo_root/src/native/runtime/src/liboliphaunt_archive_tar.c"
  "$repo_root/src/native/runtime/src/liboliphaunt_static_extensions.c"
  "$repo_root/src/native/runtime/src/liboliphaunt_builtin_extensions.c"
)
...
build_liboliphaunt_objects() {
  ...
  for source in "${liboliphaunt_sources[@]}"; do
    ...
    "${cc[@]}" $liboliphaunt_cflags \
      -I"$repo_root/src/native/runtime/include" \
      -I"$repo_root/src/native/runtime/src" \
      -c "$source" \
      -o "$object"
  done
}
...
build_uuid_dependency() {
  ...
  local source_dir="$repo_root/src/extensions/contrib/portable-uuid"
...
usage() {
  cat >&2 <<'MSG'
usage: src/native/runtime/bin/build-postgres18-ios-simulator.sh [--check-current]
MSG
}
