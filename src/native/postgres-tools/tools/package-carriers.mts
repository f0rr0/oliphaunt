...
import {
  ...
  validatePayload,
} from '../../runtime/tools/native-runtime-payload.mts';
...
const LIBOLIPHAUNT_NATIVE_TOOLS_PACKAGE_ROOT = path.join(
  ROOT,
  'src/native/postgres-tools/npm-platforms',
);
const LIBOLIPHAUNT_NATIVE_TOOLS_FACADE_ROOT = path.join(ROOT, 'src/native/postgres-tools/npm');
