...
extensions="$(bun src/native/sdks/react-native/tools/qualify-ios-carriers.mts selection)"
bun src/native/sdks/react-native/tools/stage-ios-app.mts \
  ...
  --allow-file-urls
bun src/native/sdks/react-native/tools/qualify-ios-carriers.mts verify
