...
[ ! -e "$scratch_root/src/query/ts" ]
example_dir="$scratch_root/src/examples/native/react-native-expo"
mkdir -p "$example_dir"
...
example_dir="$scratch_root/src/examples/native/react-native-expo"
mkdir -p "$example_dir"
cp "$root/src/examples/native/react-native-expo/package.json" "$example_dir/package.json"
patch_expo_example_react_native_dependency "file:$fixture/rn.tgz"
