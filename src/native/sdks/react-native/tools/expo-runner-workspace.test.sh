...
product_tools="$root/src/native/sdks/react-native/tools"
fixture="$(mktemp -d "${TMPDIR:-/tmp}/oliphaunt-rn-package-inputs.XXXXXX")"
trap 'rm -rf "$fixture"' EXIT

fixture_root="$fixture/repo"
rn_dir="$fixture_root/src/native/sdks/react-native"
source_example_dir="$fixture_root/src/examples/native/react-native-expo"
...
# shellcheck source=src/native/sdks/react-native/tools/expo-runner-workspace.sh
...
# shellcheck source=src/native/sdks/react-native/tools/expo-runner-common.sh
. "$product_tools/expo-runner-common.sh"
# shellcheck source=src/native/sdks/react-native/tools/mobile-extension-runtime.sh
. "$product_tools/mobile-extension-runtime.sh"
# shellcheck source=src/native/sdks/react-native/tools/expo-runner-runtime-resources.sh
