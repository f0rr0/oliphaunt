...
fail() { printf '%s\n' "$*" >&2; exit 1; }
source "$root/src/native/sdks/react-native/tools/mobile-extension-runtime.sh"
bun src/native/sdks/react-native/tools/mobile-extension-selection-fixture.mts "$fixture"
expect_failure() {
  local message="$1"
  shift
