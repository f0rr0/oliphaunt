...
rsync -a --exclude node_modules --exclude .build --exclude android/.gradle --exclude android/.cxx --exclude android/build --exclude ios/vendor src/native/sdks/react-native/ "$work_root/package/"
...
cp src/native/runtime/include/oliphaunt.h "$work_root/package/android/src/main/cpp/include/oliphaunt.h"
cp LICENSE THIRD_PARTY_NOTICES.md "$work_root/package/"
bun src/native/sdks/react-native/tools/stage-release-artifacts.mts "$artifact_root" "$work_root"
