...
#[cfg(feature = "mobile-bindings")]
struct ActiveRequest(Arc<RequestCancellation>);
#[cfg(feature = "mobile-bindings")]
...
#[cfg(feature = "mobile-bindings")]
struct RequestFuture(Option<Arc<RequestCancellation>>);
#[cfg(feature = "mobile-bindings")]
...
impl EngineExecutor {
    #[cfg(feature = "mobile-bindings")]
    pub(crate) fn request_cancellation(&self) -> Arc<RequestCancellation> {
    ...
    #[cfg(feature = "mobile-bindings")]
    pub(crate) async fn stream_cancellable<F>(
        &self,
        request: ProtocolRequest,
        on_chunk: F,
        cancellation: Arc<RequestCancellation>,
