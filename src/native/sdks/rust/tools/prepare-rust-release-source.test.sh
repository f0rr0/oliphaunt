...
bun src/native/sdks/rust/tools/prepare-rust-release-source.test-inputs.mts
...
bash tools/dev/bun.sh test ./src/native/sdks/rust/tools/prepare-rust-release-source.test.mts
