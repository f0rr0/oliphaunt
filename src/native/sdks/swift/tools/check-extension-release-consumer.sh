...
usage() {
	echo "usage: src/native/sdks/swift/tools/check-extension-release-consumer.sh --source-carrier FILE --cache-warm-carrier FILE --extension-carrier FILE [--extension-carrier FILE ...]"
}
...
safe_extract_zip() {
	...
	bun src/native/sdks/swift/tools/extract-verified-zip.mts \
		--archive "$archive" \
...
carrier_plan="$(
	tools/dev/bun.sh src/native/sdks/swift/tools/swift-extension-release-consumer-inputs.mts \
		"${carrier_input_args[@]}"
)"
extensions_csv="$(
	tools/dev/bun.sh src/native/sdks/swift/tools/extension-release-consumer.mts extensions "$carrier_plan"
)"
extension="$(
	tools/dev/bun.sh src/native/sdks/swift/tools/extension-release-consumer.mts extension "$carrier_plan"
)"
final_link_kind="$(
	tools/dev/bun.sh src/native/sdks/swift/tools/extension-release-consumer.mts kind "$carrier_plan"
)"
planned_native_version="$(
	tools/dev/bun.sh src/native/sdks/swift/tools/extension-release-consumer.mts version "$carrier_plan"
)"
...
swift_version="$(cat src/native/sdks/swift/VERSION)"
...
tools/dev/bun.sh src/native/sdks/swift/tools/prepare-swift-release-consumer.mts \
...
OLIPHAUNT_CARRIER_PLAN="$carrier_plan" \
	...
	tools/dev/bun.sh src/native/sdks/swift/tools/extension-release-consumer.mts write-consumer
