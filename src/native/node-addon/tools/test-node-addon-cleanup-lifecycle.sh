...
source_path="$root/src/native/node-addon/native/node-addon/fixtures/fake_liboliphaunt.cc"
include_path="$root/src/native/runtime/include"
...
node \
  src/native/node-addon/tools/node-addon-cleanup-lifecycle.test.mts \
  --addon "$addon" \
