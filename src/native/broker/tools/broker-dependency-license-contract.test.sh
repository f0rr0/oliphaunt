...
contract=src/native/broker/tools/broker-dependency-license-contract.mts
...
"$bun" src/native/broker/tools/create-release-fixture.mts --asset-dir "$scratch/assets" --version "$version"
package() {
  PATH="$scratch/empty-path" CARGO_HOME="$scratch/empty-cargo-home" \
    "$bun" src/native/broker/tools/package_broker_cargo_artifacts.mts \
...
bash tools/dev/bun.sh test ./src/native/broker/tools/broker-dependency-license-contract.test.mts
