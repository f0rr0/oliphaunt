...
`src/native/broker/tools/broker-dependency-license-contract.mts check-contract` verifies
...
`bash src/native/broker/tools/audit-dependency-licenses.sh`: Cargo fetches any
