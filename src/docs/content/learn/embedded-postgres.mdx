...
| WASIX TypeScript `@oliphaunt/wasix-ts` | Browser direct or module-Worker placement, or Node worker threads, with memory; browsers may opt into IndexedDB snapshots and Node may opt into directory snapshots |
...
| Background/checkpoint | Use platform lifecycle hooks or host-specific WASIX snapshot publication where exposed |
