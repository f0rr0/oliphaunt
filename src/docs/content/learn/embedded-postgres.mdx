...
| WASIX TypeScript `@oliphaunt/wasix-ts` | Browser, Node, Bun, or Deno direct/Worker placement with memory; browsers may opt into IndexedDB snapshots and server runtimes may opt into directory snapshots |
