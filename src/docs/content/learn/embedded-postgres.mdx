...
Contrib ships with the base SDK, and external extensions come from independent
packages. Every SDK selects explicit contrib and external descriptors when
opening a database. Installed dependencies determine which artifacts ship.
