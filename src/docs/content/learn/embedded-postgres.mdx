...
| WASIX TypeScript `@oliphaunt/wasix-ts` | Browser or Node direct/Worker placement with memory; browsers may opt into IndexedDB snapshots and Node may opt into directory snapshots |
