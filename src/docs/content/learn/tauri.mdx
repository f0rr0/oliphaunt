...
| Multiple database instances or helper-process ownership | `NativeBroker` |
...
PostgreSQL storage behind the Rust SDK. The SDK validates archive format, selected
extensions, locks, and restore destinations before moving data.
