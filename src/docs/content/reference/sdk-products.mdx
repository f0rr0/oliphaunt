...
| WASIX TypeScript | `@oliphaunt/wasix` | Browser direct or module-Worker placement, or Node worker thread | Memory filesystem |
...
logical dump tooling, transaction helpers, and protocol streaming. The
TypeScript binding owns browser and Node worker adapters, pgwire error recovery,
optional browser IndexedDB snapshots, and a narrow asynchronous API. Carrier
reuse is not API parity.
