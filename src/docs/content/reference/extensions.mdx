...
Import only the portable carrier descriptors the browser or Node application uses:
...
| WASIX TypeScript | Selective `-wasix` imports carry exact descriptors and portable bytes on browser and Node hosts |
