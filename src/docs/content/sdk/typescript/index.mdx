...
It is separate from [`@oliphaunt/wasix-ts`](/docs/sdk/wasix-typescript),
whose root owns a Worker and whose explicit `/blocking` entrypoint runs portable
guest work in the importing realm. Neither package selects or falls back to the
other.
