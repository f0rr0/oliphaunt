...
It is separate from [`@oliphaunt/wasix-ts`](/docs/sdk/wasix/browser-typescript),
which hosts the portable runtime directly or in a Worker in a browser, or in a
Node worker thread. Neither package selects or falls back to the other.
...
default. Broker mode adds process isolation and crash recovery. Server mode is
for PostgreSQL-compatible tools and independent clients.
