...
Install external packages and select their descriptors alongside contrib descriptors
when opening a database. Base contrib ships with the SDK; external bytes come
from their independently versioned packages.
