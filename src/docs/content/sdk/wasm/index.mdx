...
can instead deploy the separate [WASIX postmaster](/docs/sdk/wasix/runtime#wasix-postmaster)
...
[WASIX TypeScript](/docs/sdk/wasix/browser-typescript). Concurrent server
deployments start with [WASIX postmaster](/docs/sdk/wasix/runtime#wasix-postmaster).
