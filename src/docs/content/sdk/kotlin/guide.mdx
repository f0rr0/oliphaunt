...
Declare external packages as Gradle dependencies. The plugin packages them with
base contrib; each database explicitly selects descriptors in its configuration.
