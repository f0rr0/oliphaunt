...
- read capability bits and error strings;
...
target artifact so bindings can report protocol, streaming, backup/restore,
extension, cancellation, and lifecycle support.
...
- Translate capability bits and error strings into ecosystem-native types.
