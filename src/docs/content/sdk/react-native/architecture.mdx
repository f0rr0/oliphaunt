...
| Swift SDK | Apple storage, template hydration, native direct lifecycle, queries, extensions, backup/restore |
| Kotlin SDK | Android storage, template hydration, native direct lifecycle, queries, extensions, backup/restore |
...
The public surface is open, typed query/execute, buffered raw protocol,
transaction, checkpoint, cancellation, physical backup, static restore, and
close. There is no generic protocol-stream API or app-background mode.
