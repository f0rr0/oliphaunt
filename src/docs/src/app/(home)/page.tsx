...
const examples = [
  ...
  },
  {
    ...
    href: `${githubRoot}/src/examples/native/electron`,
  },
  {
    ...
    href: `${githubRoot}/src/examples/wasix/electron`,
  },
] as const;
