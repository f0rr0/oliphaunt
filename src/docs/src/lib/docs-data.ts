...
export const sdkSurfaces: SdkSurface[] = [
  ...
  },
  {
    ...
    guideOutcomes: [
      ...
      'Opt into IndexedDB or native-host directory storage when operation-boundary and clean-close persistence fits the app.',
      'Add the optional tools package everywhere or the local `/server` subpath on Node, Bun, Deno, and Electron only when needed.',
    ],
    icon: Braces,
  },
  {
