...
export const sdkSurfaces: SdkSurface[] = [
  ...
  },
  {
    ...
    modes: ['direct'],
    verifyFirst: 'Open from app storage, run a query off the main actor, checkpoint, and close.',
    guideOutcomes: [
      'Add the Swift package to an iOS or macOS app target.',
      'Open from Swift concurrency without blocking the main actor.',
      'Coordinate exact extensions, checkpoint, and backup/restore.',
    ],
    icon: Smartphone,
  },
  {
    ...
    guideOutcomes: [
      ...
      'Package only selected extensions and use checkpoint, cancellation, and close explicitly.',
    ],
    icon: Smartphone,
  },
  {
  ...
  },
  {
    ...
    owns: 'Browser, Node, Bun, and Deno Worker hosting, pgwire recovery, selective extension imports, and optional host-specific persistence.',
...
export const runtimeModes: RuntimeMode[] = [
  ...
  },
  {
    ...
    boundary: 'Memory by default, optional browser IndexedDB or OPFS persistence, optional Node/Bun/Deno directory persistence, and no native fallback.',
    icon: Boxes,
  },
];
