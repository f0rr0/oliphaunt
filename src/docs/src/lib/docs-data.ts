...
export const sdkSurfaces: SdkSurface[] = [
  ...
  },
  {
    ...
    owns: 'Browser, Node, Bun, and Deno Worker hosting, pgwire recovery, selective extension imports, and optional host-specific snapshots.',
...
export const runtimeModes: RuntimeMode[] = [
  ...
  },
  {
    ...
    boundary: 'Memory by default, optional browser IndexedDB or Node/Bun/Deno directory snapshots, and no native fallback.',
    icon: Boxes,
  },
];
