...
export const sdkSurfaces: SdkSurface[] = [
  ...
  },
  {
    ...
    owns: 'Browser and Node Worker hosting, pgwire recovery, selective extension imports, and optional host-specific snapshots.',
    ...
    guideOutcomes: [
      ...
      'Opt into IndexedDB or Node directory storage when checkpoint and clean-close persistence fits the app.',
    ],
    icon: Braces,
  },
  {
...
export const runtimeModes: RuntimeMode[] = [
  ...
  },
  {
    ...
    boundary: 'Memory by default, optional browser IndexedDB or Node directory snapshots, and no native fallback.',
    icon: Boxes,
  },
];
