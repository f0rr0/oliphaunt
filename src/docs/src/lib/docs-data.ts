...
export const sdkSurfaces: SdkSurface[] = [
  ...
  },
  {
    ...
    owns: 'Browser, Node, Bun, and Deno Worker hosting, bounded pgwire streaming, optional tools, host-specific local servers, selective extensions, and persistence.',
