...
/**
 * Official WASIX mark, adapted from the MIT-licensed WASIX site component.
 * Source pinned at wasix-org/wasix.org@d084eeea153766d6d419d995be0585cd0eac86ac.
 */
export function WasixMark({ className, ...props }: ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      aria-hidden="true"
      className={cn('wasix-mark', className)}
      fill="none"
      viewBox="0 0 1494 1494"
      xmlns="http://www.w3.org/2000/svg"
      {...props}
    >
      <path className="wasix-mark__bridge" d="M1158 783.996H378v161h780v-161Z" />
      <path
        className="wasix-mark__surface"
        strokeWidth="4"
