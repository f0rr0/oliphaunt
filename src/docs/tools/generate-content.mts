...
import { generateApiReferenceArtifacts } from './generate-api-reference.mts';
...
export function generateDocs(options = {}) {
  ...
  const sdkManifest = parseTomlFile(
    path.join(repoRoot, 'src/shared/product-metadata/sdk-manifest.toml'),
  );
