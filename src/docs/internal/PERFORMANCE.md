...
> release evidence or API guidance. Use `src/docs/maintainers/performance-evidence.md`
...
[`src/docs/content/reference/performance.mdx`](../content/reference/performance.mdx).
