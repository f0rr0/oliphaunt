...
- Ran Node benchmark plan `src/benchmarks/wasix/node-pglite-memory-v1.json`
...
node src/benchmarks/perf/wasix-node/benchmark.mts --run --config src/benchmarks/wasix/node-pglite-memory-v1.json --output target/perf/wasix-node-run-20260814
```
