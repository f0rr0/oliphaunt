...
cd "$root"
source "$root/runtimes/liboliphaunt-wasix-postmaster/lib/process-supervision.sh"
...
# Keep descendant cleanup and diagnostics inside the outer 120-minute job bound.
proof_timeout_ms=$((30 * 60 * 1000))
