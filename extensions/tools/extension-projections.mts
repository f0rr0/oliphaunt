...
export const modelPath = 'extensions/tools/check-extension-model.sh';
export const catalogPath = 'extensions/generated/extensions.catalog.json';
export const contribPath = 'extensions/contrib/postgres18.toml';
const componentsPath = 'extensions/catalog/native-components.toml';
const externalRoot = 'extensions/external';
const smokeRoot = 'test-fixtures/extensions';
...
export function extensionProjections(catalog: Row, releases: Row[]): Map<string, string> {
  ...
  const base = 'extensions/generated';
  ...
  for (const [sdk, includeIos] of [
    ...
    const type = fields
      ...
      .join('\n');
    outputs.set(
      `sdks/${sdk}/src/generated/extensions.ts`,
  ...
  outputs.set(
    'sdks/kotlin/oliphaunt-android-gradle-plugin/src/main/resources/dev/oliphaunt/android/extensions.properties',
    [
      `# This file is generated by ${modelPath}.`,
      '# Do not edit by hand.',
...
export function discoverCatalog(): Row {
  const catalog = readJson('extensions/catalog/extensions.source.json');
  ...
  return {
    'format-version': 1,
    'generated-from': [
      { name: 'postgres18-source', path: 'third-party/postgres/source.toml' },
      { name: 'extension-catalog', path: 'extensions/catalog/extensions.source.json' },
...
export function catalogProjections(catalog: Row): Map<string, string> {
  ...
  outputs.set('extensions/generated/contrib-build.tsv', `${contrib.join('\n')}\n`);
  outputs.set('extensions/generated/pgxs-build.tsv', `${pgxs.join('\n')}\n`);
  outputs.set(
    'sdks/rust-wasix/src/oliphaunt/generated_extensions.rs',
