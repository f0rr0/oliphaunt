...
bash runtimes/liboliphaunt-wasix/tools/runtime-smoke.sh regression
bash extensions/tools/check-extension-model.sh \
  --record-wasix-evidence-run "$run_id" \
  --observed-at "$observed_at"
bash extensions/tools/check-extension-model.sh --check --require-current-evidence
