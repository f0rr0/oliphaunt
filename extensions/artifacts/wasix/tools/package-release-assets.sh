...
[ -f "$root/package.json" ] && [ -d "$root/extensions/artifacts/wasix" ] || {
...
generated_metadata="$root/extensions/generated/wasix/extensions.json"
...
bun \
  "$root/extensions/artifacts/wasix/tools/package-release-assets.mts" \
  --root "$root" \
