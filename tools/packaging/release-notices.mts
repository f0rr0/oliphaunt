...
function usage() {
  return [
    'usage:',
    '  tools/packaging/release-notices.mts stage <directory> --profile <carrier-profile>',
    '  tools/packaging/release-notices.mts check-directory <directory> --profile <carrier-profile>',
    '  tools/packaging/release-notices.mts check-archive <archive> --profile <carrier-profile> [--prefix <member-prefix>]',
