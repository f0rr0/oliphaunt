...
export function requireCompatibilityVersionBounds(
  { id, value, sourceProduct, sourceVersion },
  { prefix = 'compatibility-version-policy' } = {},
) {
...
export function requireCompatibilityVersionBinding(
  { id, value, expected, sourceProduct, sourceVersion, provenance },
  { prefix = 'compatibility-version-policy' } = {},
) {
  requireCompatibilityVersionBounds({ id, value, sourceProduct, sourceVersion }, { prefix });
