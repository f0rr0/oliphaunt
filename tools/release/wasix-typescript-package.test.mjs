...
function manifest() {
  return {
    ...
    exports: {
      ...
      '.': {
        deno: { types: './lib/index.deno.d.ts', default: './lib/index.deno.js' },
        bun: { types: './lib/index.bun.d.ts', default: './lib/index.bun.js' },
        node: { types: './lib/index.node.d.ts', default: './lib/index.node.js' },
        browser: { types: './lib/index.d.ts', default: './lib/index.js' },
        default: { types: './lib/index.d.ts', default: './lib/index.js' },
      },
      './worker': {
        deno: { types: './lib/worker-entry.deno.d.ts', default: './lib/worker-entry.deno.js' },
        bun: { types: './lib/worker-entry.bun.d.ts', default: './lib/worker-entry.bun.js' },
        node: { types: './lib/worker-entry.node.d.ts', default: './lib/worker-entry.node.js' },
        browser: { types: './lib/worker-entry.d.ts', default: './lib/worker-entry.js' },
        default: { types: './lib/worker-entry.d.ts', default: './lib/worker-entry.js' },
      },
      './direct': {
