...
def validate_publish_target_coverage() -> None:
    ...
    if (
        ...
        or "Other product dry-runs" in release_publish
        or "publish-dry-run is Bun-owned" not in release_publish
        or "GITHUB_RELEASE_ASSET_PUBLISHERS" not in release_publish
        ...
        or "publishNodeDirectNpmOptionalPackages" not in release_publish
        or "nodeDirectOptionalNpmTarballs" not in release_publish
        or "npmPublishTarball(packageName, tarball, version)" not in release_publish
        or "requireProductRegistryPublished(product, null)" not in release_publish
        ...
        or "publishLiboliphauntNativeCargoArtifacts" not in release_publish
        or "liboliphauntNativeCargoArtifactPackages(version)" not in release_publish
        or "for (const { name, manifestPath } of liboliphauntNativeCargoArtifactPackages(version))" not in release_publish
        or "publishLiboliphauntWasixCargoArtifacts" not in release_publish
        or "liboliphauntWasixCargoArtifactPackages(version)" not in release_publish
        or "for (const { name, manifestPath } of liboliphauntWasixCargoArtifactPackages(version))" not in release_publish
        ...
        or '"oliphaunt-broker"' not in release_publish
        or '"oliphaunt-node-direct"' not in release_publish
        ...
        or 'registryPackageRows({ product: LIBOLIPHAUNT_NATIVE_PRODUCT, packageKind: "crates" }' not in release_product_dry_run
        or "export function liboliphauntNativeCargoArtifactPackages" not in release_product_dry_run
        ...
        or 'registryPackageRows({ product: WASIX_PRODUCT, packageKind: "crates" }' not in release_product_dry_run
        or "export function liboliphauntWasixCargoArtifactPackages" not in release_product_dry_run
