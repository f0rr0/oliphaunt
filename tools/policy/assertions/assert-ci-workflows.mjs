...
requireText(releasePath, "release_plan_args=(");
requireText(releasePath, "--from-product-tags");
requireText(releasePath, "--include-current-tags");
requireText(releasePath, '--head-ref "$RELEASE_HEAD_SHA"');
requireText(releasePath, "--format github-output");
requireText(releasePath, "--include-current-version-tags");
requireText(releasePath, 'tools/dev/bun.sh tools/release/release_plan.mjs "${release_plan_args[@]}"');
