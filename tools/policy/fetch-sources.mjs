...
function validateWasixToolchain(manifest) {
  assertEquals(manifest.toolchain?.wasmer, '7.2.0-alpha.3', 'toolchain.wasmer');
  assertEquals(manifest.toolchain?.['wasmer-wasix'], '0.702.0-alpha.3', 'toolchain.wasmer-wasix');
