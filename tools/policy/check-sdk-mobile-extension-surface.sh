...
require_text src/sdks/kotlin/oliphaunt/build.gradle.kts 'requireExtensionAsset(manifest, product, target, "android-static-archive", sqlName)' \
  "Kotlin Android release-asset resolver must download target static archives for selected native-module extensions"
require_text src/sdks/kotlin/oliphaunt/build.gradle.kts "validateEquivalentAndroidRuntimeAssets" \
  "Kotlin Android release-asset resolver must verify Android runtime extension payloads are ABI-independent"
require_text src/sdks/kotlin/oliphaunt-android-gradle-plugin/src/main/java/dev/oliphaunt/android/ResolveOliphauntAndroidAssetsTask.java '"android-static-archive"' \
  "Kotlin Android public Gradle plugin must download target static archives for selected native-module extensions"
require_text src/sdks/kotlin/oliphaunt-android-gradle-plugin/src/main/java/dev/oliphaunt/android/ResolveOliphauntAndroidAssetsTask.java "validateEquivalentAndroidRuntimeAssets" \
  "Kotlin Android public Gradle plugin must verify Android runtime extension payloads are ABI-independent"
