...
reject_text src/sdks/react-native/OliphauntReactNative.podspec "ios/generated/static-registry/*.c" \
  "selection-neutral React Native package must not compile app-specific static registry glue"
require_text src/sdks/react-native/tools/stage-ios-app.mjs 's.source_files = "generated/static-registry/*.c"' \
  "app-owned React Native iOS payload must compile generated exact-extension static registry glue"
...
require_text src/sdks/react-native/README.md "tools/stage-ios-app.mjs" \
  "React Native SDK docs must document app-owned selected-extension iOS staging"
require_text src/sdks/react-native/README.md "oliphaunt-react-native-ios-carriers.json" \
  "React Native SDK docs must document checksum-locked iOS carrier selection"
