...
const expectedDirectDependencies = new Map([
  ...
  ...externalExtensionProducts.map((product) => [
    product,
    ['extension-runtime-contract', 'liboliphaunt-native', 'liboliphaunt-wasix'],
  ]),
  ['extension-model', []],
...
assertTaskOutput(tasks, 'liboliphaunt-wasix', 'runtime-portable', 'target/oliphaunt-wasix/wasix-build/build/**/*');
assertTaskOutput(
  tasks,
  'liboliphaunt-wasix',
  'runtime-portable',
...
assertTaskOutput(tasks, 'liboliphaunt-wasix', 'runtime-portable', 'target/oliphaunt-wasix/assets/**/*');
rejectTaskInput(
  tasks,
  'liboliphaunt-wasix',
  'runtime-aot',
