...
require_text src/runtimes/liboliphaunt/native/bin/icu.sh "oliphaunt_icu_static_data_ready" \
...
require_text src/runtimes/liboliphaunt/native/bin/icu.sh "oliphaunt_icu_linked_symbols_ready" \
  "liboliphaunt ICU helper must verify static ICU data and registration symbols in final binaries"
...
require_text src/runtimes/liboliphaunt/native/bin/icu.sh "install-local" \
  "liboliphaunt ICU helper must install the real static ICU data archive"
require_text src/runtimes/liboliphaunt/native/patches/postgresql-18.4/0013-liboliphaunt-register-static-icu-data.patch "udata_setCommonData" \
  "PostgreSQL static ICU patch must register linked ICU common data"
...
require_text src/runtimes/liboliphaunt/native/bin/build-postgres18-ios-simulator.sh "oliphaunt_icu_linked_symbols_ready" \
  "iOS simulator artifact gate must prove static ICU is linked into the final dylib"
...
require_text src/runtimes/liboliphaunt/native/bin/build-postgres18-ios-device.sh "oliphaunt_icu_linked_symbols_ready" \
  "iOS device artifact gate must prove static ICU is linked into the final dylib"
...
require_text src/runtimes/liboliphaunt/native/bin/build-postgres18-android-arm64.sh "oliphaunt_icu_linked_symbols_ready" \
  "Android artifact gate must prove static ICU is linked into the final shared library"
