...
if [[ "$changed_files" == "*" ]]; then
  ...
  while IFS= read -r file; do
    ...
    case "$file" in
      .github/workflows/* | .github/scripts/* | .github/actions/* | .github/zizmor.yml | tools/scripts/* | prek.toml | deny.toml | clippy.toml | rust-toolchain.toml)
        repo=true
        ci=true
        ;;
      .github/*)
    ...
    case "$file" in
      Cargo.toml | build.rs | crates/*/Cargo.toml | crates/aot/*/Cargo.toml)
        ...
        package=true
        ;;
      Cargo.lock | crates/pglite-oxide/* | crates/libpglite-oxide/* | libpglite/*)
        repo=true
        rust=true
        ;;
      tools/xtask/*)
