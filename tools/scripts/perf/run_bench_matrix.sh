...
POSTGRES_BIN="${LIBPGLITE_OXIDE_POSTGRES:-${PGLITE_OXIDE_NATIVE_POSTGRES:-/opt/homebrew/opt/postgresql@18/bin/postgres}}"
INITDB_BIN="${LIBPGLITE_OXIDE_INITDB:-${PGLITE_OXIDE_NATIVE_INITDB:-/opt/homebrew/opt/postgresql@18/bin/initdb}}"
