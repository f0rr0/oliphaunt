...
JUST_VERSION="${JUST_VERSION:-1.51.0}"
...
Remove or update the existing $binary so tools/scripts/bootstrap-tools.sh can provide
...
install_cargo_tool just just "$JUST_VERSION"
