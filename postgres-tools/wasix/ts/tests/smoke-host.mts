...
const seed = await readFile(resolve(root, 'test-fixtures/postgres/logical-tools-seed.sql'), 'utf8');
const verify = await readFile(
  resolve(root, 'test-fixtures/postgres/logical-tools-verify.sql'),
  'utf8',
);
const fixture = JSON.parse(
  await readFile(resolve(root, 'test-fixtures/postgres/logical-tools.json'), 'utf8'),
);
