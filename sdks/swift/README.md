...
node sdks/swift/tools/render-extension-products.mjs \
...
`sdks/swift/Carriers/oliphaunt-react-native-ios-carriers.json`. It pins only
...
swift test --filter NativeRuntimeTests
```
...
inside `sdks/swift`, or use the corresponding Moon tasks. The Shell entry point
