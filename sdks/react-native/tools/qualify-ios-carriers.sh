...
extensions="$(bun sdks/react-native/tools/qualify-ios-carriers.mts selection)"
bun sdks/react-native/tools/stage-ios-app.mts \
  ...
  --allow-file-urls
bun sdks/react-native/tools/qualify-ios-carriers.mts verify
