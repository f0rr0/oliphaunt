...
urlencode() {
  bun "$root/sdks/react-native/tools/expo-runner-common.mts" urlencode "$1"
}

react_native_package_tarball_name() {
  bun "$root/sdks/react-native/tools/expo-runner-common.mts" tarball-name "$1/package.json"
}
