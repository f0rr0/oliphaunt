...
const REACT_NATIVE_EXTENSION_METADATA = path.join(ROOT, 'extensions/generated/sdk/extensions.json');

const MOBILE_STATIC_REGISTRY = path.join(ROOT, 'extensions/generated/mobile/static-registry.json');
