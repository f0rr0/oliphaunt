...
use crate::pglite::extensions::{
    Extension, by_sql_name, extension_session_setup_sql, extension_setup_sql,
    native_extension_setup_sql, resolve_extension_set,
};
...
impl Pglite {
    ...
    pub fn enable_extension(&mut self, extension: Extension) -> Result<()> {
        ...
        if matches!(self.backend, BackendSession::Native(_)) {
