...
const domainEntries = Object.freeze([
  Object.freeze(['third-party/icu', sourceOrigins.sharedThirdParty]),
  Object.freeze(['third-party/openssl', sourceOrigins.sharedThirdParty]),
  Object.freeze(['runtimes/liboliphaunt-native/sources', sourceOrigins.nativeThirdParty]),
  Object.freeze([
    'runtimes/liboliphaunt-wasix-postmaster/sources',
    sourceOrigins.wasixPostmasterThirdParty,
  ]),
]);
