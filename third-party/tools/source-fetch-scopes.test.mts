...
const productionDomains = [
  ['third-party/icu', sourceOrigins.sharedThirdParty],
  ['third-party/openssl', sourceOrigins.sharedThirdParty],
  ['runtimes/liboliphaunt-native/sources', sourceOrigins.nativeThirdParty],
  ['runtimes/liboliphaunt-wasix-postmaster/sources', sourceOrigins.wasixPostmasterThirdParty],
];
...
test('focused runtime scopes include the extension sources they package', () => {
  assert.deepEqual(sourceDomainsForScope('native-runtime'), productionDomains.slice(0, 3));
