...
if env FRESH_PROJECT_SOURCE_ID_PREFIX=runtimes/liboliphaunt-wasix-postmaster \
...
[ "$(fresh_project_source_identity_path \
  ...
  "runtimes/liboliphaunt-wasix-postmaster/wasmer/patches/wasix-libc/0001-postgres-wasix-blockers.patch" ]
...
WASIX_TOOLCHAIN_ROOT="$REPO_ROOT/../$(basename "$REPO_ROOT")/runtimes/liboliphaunt-wasix/assets/build"
if fresh_runtime_build_recipe_sha256 >/dev/null 2>&1; then
