...
SOURCE_TOML="$REPO_ROOT/third-party/postgres/source.toml"
PATCH_DIR="$REPO_ROOT"
PATCH_SERIES="$REPO_ROOT/runtimes/liboliphaunt-wasix/postgres/series"
...
bash "$REPO_ROOT/third-party/postgres/apply-series.sh" "$PATCHED_PGSRC" "$PATCH_SERIES" --context-fuzz >&2
