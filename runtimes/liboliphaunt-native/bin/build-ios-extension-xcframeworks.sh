...
headers_dir="$repo_root/runtimes/liboliphaunt-native/include"
...
usage() {
  cat >&2 <<USAGE
usage: runtimes/liboliphaunt-native/bin/build-ios-extension-xcframeworks.sh [--check-current] [--runtime-resources <dir>]
