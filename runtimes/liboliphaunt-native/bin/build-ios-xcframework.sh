...
runtime_version_file="$repo_root/runtimes/liboliphaunt-native/VERSION"
...
simulator_script="$repo_root/runtimes/liboliphaunt-native/bin/build-postgres18-ios-simulator.sh"
device_script="$repo_root/runtimes/liboliphaunt-native/bin/build-postgres18-ios-device.sh"
macos_script="$repo_root/runtimes/liboliphaunt-native/bin/build-postgres18-macos.sh"
public_header="$repo_root/runtimes/liboliphaunt-native/include/oliphaunt.h"
...
usage() {
  cat >&2 <<'MSG'
usage: runtimes/liboliphaunt-native/bin/build-ios-xcframework.sh [--check-current]
MSG
}
...
build_xcframework() {
  ...
  rsync -a --delete "$repo_root/runtimes/liboliphaunt-native/include/" "$headers_dir/"
