...
helper="$root/extensions/external/postgis/tools/reproducible-time.sh"
shim="$root/extensions/external/postgis/tools/reproducible-bin/date"
...
fake_manifest="$fake_root/extensions/external/postgis/source.toml"
