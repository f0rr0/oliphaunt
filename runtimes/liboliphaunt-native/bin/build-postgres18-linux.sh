...
usage() {
  cat >&2 <<'MSG'
usage: runtimes/liboliphaunt-native/bin/build-postgres18-linux.sh [--runtime-only|--print-required-extension-artifacts|--check-current|--check-extension-artifacts-current]
MSG
}
