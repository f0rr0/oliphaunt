...
specified below; updated 2026-09-08.
...
3. Seed bytes must leave default runtime archives and Cargo/npm/Maven/mobile
   resources. WASIX N-API currently embeds seeds and ICU data; SwiftPM's ICU
   resources share the default source package. Optional dependency declarations
   alone do not remove those downloads.
