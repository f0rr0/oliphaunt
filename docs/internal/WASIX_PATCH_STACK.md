...
| 42 | `0042-oliphaunt-wasix-use-explicit-wal-sync-operations.patch` | Oliphaunt Maintainers <dev@oliphaunt.dev> | oliphaunt-wasix: use explicit WAL sync operations |
| 43 | `0043-oliphaunt-wasix-cache-jsonb-build-object-metadata.patch` | Oliphaunt Maintainers <dev@oliphaunt.dev> | oliphaunt-wasix: cache jsonb_build_object metadata |
