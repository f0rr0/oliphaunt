# Retired liboliphaunt Track Review

The 2026-05-16 working review has been retired. It described APIs, ownership,
and release gaps that no longer match the repository and is intentionally not
kept as an alternate specification.

Use the current normative documents instead:

- [`docs/maintainers/sdk-parity-policy.md`](../maintainers/sdk-parity-policy.md)
...
tasks remain authoritative when prose and implementation disagree.
