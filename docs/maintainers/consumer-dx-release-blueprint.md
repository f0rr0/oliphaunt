...
Status: authoritative implementation plan. This replaces the previous research
...
plugins {
    ...
    id("dev.oliphaunt.android") version "0.0.1"
}

dependencies {
    implementation("dev.oliphaunt:oliphaunt:0.0.1")
}

oliphaunt {
    runtimeVersion.set("0.0.1")
...
```swift
.package(url: "https://github.com/f0rr0/oliphaunt.git", exact: "0.0.1")
```
...
- release-please owns versions, tags, and changelogs.
